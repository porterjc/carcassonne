...
public class PlayableTileRoadTest2 {
    ...
    public void testsRoadToScoreComepletedAndNotCompleteEndOfGame(){
        ...
        assertEquals(2, scores.size()); //TODO FINISH THIS ONE
    ...
    public void testObtainMeeplesFromManyLocations(){
        ...
        Set<AbstractTile> alreadyvisited = new HashSet<AbstractTile>();
        Set<Meeple> meeples = new HashSet<Meeple>();
        Pair<Set<Meeple>, Integer> scores = bottom.scoreRoad(alreadyvisited, meeples, true).pop();
        assertEquals(2, scores.getKey().size());
