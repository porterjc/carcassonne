...
public class PlayableTileFarmerTest {
    ...
    @Test
    public void testFindFarmerAcross4WayIntersection() {
        HashMap<GlobalVariables.Direction, GlobalVariables.Feature> feature1 = new HashMap<>();
        feature1.put(GlobalVariables.Direction.NORTH, GlobalVariables.Feature.ROAD);
        feature1.put(GlobalVariables.Direction.EAST, GlobalVariables.Feature.ROAD);
        feature1.put(GlobalVariables.Direction.WEST, GlobalVariables.Feature.ROAD);
    ...
    @Test
    public void testFindFarmerAroundMonasteryVertical() {
        HashMap<GlobalVariables.Direction, GlobalVariables.Feature> feature1 = new HashMap<>();
        feature1.put(GlobalVariables.Direction.NORTH, GlobalVariables.Feature.ROAD);
        feature1.put(GlobalVariables.Direction.EAST, GlobalVariables.Feature.GRASS);
        feature1.put(GlobalVariables.Direction.WEST, GlobalVariables.Feature.GRASS);
        ...
        tile2.setMeeple(m);
        assertTrue(tile1.traceField(new HashSet<AbstractTile>(), GlobalVariables.Location.LEFT, new HashSet<Meeple>(), new HashSet<Integer>(), false));
    }
    ...
    public void testFindFarmerUpSplitPath() {
        ...
        tile1.setMeeple(m);
        assertTrue(tile3.traceField(new HashSet<AbstractTile>(), GlobalVariables.Location.BOTTOM, new HashSet<Meeple>(), new HashSet<Integer>(), false));
    ...
    public void testFarmerAcrossT() {
        ...
        m.place(tile2, GlobalVariables.Feature.GRASS, GlobalVariables.Location.TOP);
        tile1.setMeeple(m);
        assertTrue(tile3.traceField(new HashSet<AbstractTile>(), GlobalVariables.Location.TOPRIGHT, new HashSet<Meeple>(), new HashSet<Integer>(), false));
    }
    ...
    @Test
    public void testFullGrassLeftEdge() {
        HashMap<GlobalVariables.Direction, GlobalVariables.Feature> feature1 = new HashMap<>();
        feature1.put(GlobalVariables.Direction.NORTH, GlobalVariables.Feature.ROAD);
        feature1.put(GlobalVariables.Direction.EAST, GlobalVariables.Feature.ROAD);
        feature1.put(GlobalVariables.Direction.WEST, GlobalVariables.Feature.GRASS);
